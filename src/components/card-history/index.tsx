...
export const CardHistory = ({ preview, content, title }: CardHistoryProps) => {
  return (
    <div className="w-full rounded-2xl overflow-hidden flex flex-col md:flex-row h md:h-[600px] cursor-pointer">
      ...
      <main className="flex flex-col w-full h-full gap-4 p-4 bg-white md:p-10 md:w-7/12 ">
